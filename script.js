...
window.addEventListener("load", initSwiper);
  ...
  const lines = [
    "Success is not just about reaching the top, but lifting others as you climb.",
    "Every challenge is a lesson; every setback is a setup for a stronger comeback.",
    "Your greatest impact lies in the people you inspire and empower.",
    "Lead with kindness, teach with patience, and inspire with your actions."
  ];
  ...
  function displayNextLine() {
    ...
    textContainer.innerText = lines[index];
  ...
  // Start the line-by-line display
  displayNextLine();
